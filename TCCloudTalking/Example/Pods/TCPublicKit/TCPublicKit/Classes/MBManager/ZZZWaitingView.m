...
static CGFloat const kZZZWaitingViewCenterViewWidth = 48.0;
static CGFloat const kZZZWaitingViewImageViewWidth = 50.0;
...
- (void)loadGifWithStyle:(ZZZWaitingViewStyle)style {
    ...
    if (style == ZZZWaitingViewStyleGray) {
        color = [UIColor whiteColor];//[UIColor colorWithHexString:@"#ffa055"];//[UIColor colorWithRed:163.0/255.0 green:163.0/255.0 blue:163.0/255.0 alpha:1.0];
    } else {
