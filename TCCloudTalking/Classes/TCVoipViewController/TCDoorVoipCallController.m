...
- (void)funtionButtonClick:(UIButton *)button{
    ...
    {
        [TCOpenDoorTool openTheDoorWithID:[TCCloudTalkingTool getMachineNumberWithVoipNo:self.voipNo] DoorName:[TCCloudTalkingTool getMachineNameWithVoipNo:self.voipNo] TalkID:self.voipNo];
